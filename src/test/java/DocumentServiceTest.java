...
public class DocumentServiceTest {
    ...
    @Mock
    @Autowired
    private IDocumentRepository documentDao;
    ...
    public void testFindByUserIdAndTimestampBetween() {
        ...
        Page<Document> result = documentService.filterBy(start, end, user.getId(), String.valueOf(Action.UPLOADED), Pageable.ofSize(1));
